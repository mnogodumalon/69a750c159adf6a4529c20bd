...
import { FileText, LayoutDashboard, Menu, Tag, Tags, X } from 'lucide-react';
import { useState } from 'react';
import ChatWidget from '@/components/ChatWidget';

// ⚡ Customize these for your app
const APP_TITLE = 'Sonnenschein & Glück';

const navigation = [
  { name: 'Übersicht', href: '/', icon: LayoutDashboard },
  { name: 'Aktivitäten', href: '/aktivitaeten', icon: FileText },
  { name: 'Stimmungskategorien', href: '/stimmungskategorien', icon: Tag },
  { name: 'Tägliche Stimmung', href: '/taegliche-stimmung', icon: Tags },
  { name: 'Positive Momente', href: '/positive-momente', icon: FileText },
];
